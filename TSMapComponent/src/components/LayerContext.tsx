...
const initialContext = () => {
    return {
        ...
        layerObj: {
            ...
            [LayerId.LAWSON_TRADE_AREA_LAYER]: {
                isEnable: true,
                featureList: [],
            },
