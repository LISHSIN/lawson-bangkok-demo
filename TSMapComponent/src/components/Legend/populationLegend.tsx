...
export interface PopulationLegendProps {
}

export const PopulationLegendFC: React.FC<PopulationLegendProps> = (props => {
    ...
    if ((showAllPopulationLegend === false) && (showAgeAndGenderWisePopulationLegend === false)) {
      legendClasses = "population-legend hide";
    } else {
      legendClasses = "population-legend show";
    }
...
export default PopulationLegendFC;
